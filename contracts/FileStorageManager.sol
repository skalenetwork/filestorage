...
//        (bool status, bytes memory returnedData) = _impl.delegatecall(msg.data);
//        assembly {
////            let ptr := mload(0x40)
...
//            switch status
//            case 0 { revert(add(returnedData, 0x20), returndatasize) }
//            default { return(add(returnedData, 0x20), returndatasize) }
//        }
    }
}